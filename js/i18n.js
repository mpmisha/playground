...
const STRINGS = {
  en: {
    ...
    shareTitle: 'Share',
    share: '🔗 Share Playground',
    shareText: 'Come play Playground — calm, ad-free games for kids 💜',
    shareCopied: 'Link copied! ✓',
    helpFeedback: 'Requests & feedback',
    suggestGame: '🎲 Suggest a game',
    sendFeedback: '💬 Send feedback',
    feedbackFormTitleSuggest: 'Suggest a game',
    feedbackFormTitleFeedback: 'Send feedback',
    feedbackPlaceholderSuggest: 'Which game would you like to see?',
    feedbackPlaceholderFeedback: 'Tell us what you think…',
    send: 'Send',
    cancel: 'Cancel',
  ...
  he: {
    ...
    shareTitle: 'שיתוף',
    share: '🔗 שיתוף פלייגראונד',
    shareText: 'בואו לשחק בפלייגראונד — משחקים רגועים לילדים, בלי פרסומות 💜',
    shareCopied: 'הקישור הועתק! ✓',
    helpFeedback: 'בקשות ומשוב',
    suggestGame: '🎲 הצעת משחק',
    sendFeedback: '💬 שליחת משוב',
    feedbackFormTitleSuggest: 'הצעת משחק',
    feedbackFormTitleFeedback: 'שליחת משוב',
    feedbackPlaceholderSuggest: 'איזה משחק תרצו לראות?',
    feedbackPlaceholderFeedback: 'ספרו לנו מה דעתכם…',
    send: 'שליחה',
    cancel: 'ביטול',
    feedbackThanks: 'תודה! 💜',
    feedbackEmpty: 'כתבו משהו קודם.',
  },
};
